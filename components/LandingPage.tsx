...
export default function LandingPage({ content }: { content: LandingContent }) {
        const products: Product[] = productsData.filter(p => p.active);
        return (
                <>
                        <EmailPopup />
                        <section className="flex flex-col items-center text-center bg-green-100 p-8">
                                ...
                                <div className="flex gap-4 justify-center">
                                        <Link href="#products" className="bg-green-600 text-white px-6 py-3 rounded shadow hover:bg-green-700 transition">
                                                Shop Now
                                        </Link>
                                        <Link href="/bundles" className="bg-yellow-500 text-white px-6 py-3 rounded shadow hover:bg-yellow-600 transition font-semibold">
